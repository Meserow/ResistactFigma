...
const _kv_set = async (key: string, value: any): Promise<void> => {
...
const _kv_get = async (key: string): Promise<any> => {
  const supabase = kvClient()
...
const _kv_del = async (key: string): Promise<void> => {
  const supabase = kvClient()
...
const _kv_mset = async (keys: string[], values: any[]): Promise<void> => {
  const supabase = kvClient()
...
const _kv_mget = async (keys: string[]): Promise<any[]> => {
  const supabase = kvClient()
...
const _kv_mdel = async (keys: string[]): Promise<void> => {
  const supabase = kvClient()
...
const _kv_getByPrefix = async (prefix: string): Promise<any[]> => {
  const supabase = kvClient()
