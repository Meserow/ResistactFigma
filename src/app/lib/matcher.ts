...
export const DEFAULT_CATEGORY_TONE: Record<string, Tone> = {
  ...
  "ART":            { anger: 1, comedy: 2, subversion: 2, care: 1, hope: 1, energy: 2 },
  "PETITION":             { anger: 1, comedy: 0, subversion: 0, care: 1, hope: 3, energy: 0 },
  "EMAIL":       { anger: 1, comedy: 0, subversion: 0, care: 1, hope: 3, energy: 0 },
  "WRITING":     { anger: 1, comedy: 0, subversion: 0, care: 1, hope: 3, energy: 0 },
  ...
  "KINDNESS":      { anger: 0, comedy: 0, subversion: 0, care: 3, hope: 2, energy: 1 },
  ...
  "GROUP":                { anger: 1, comedy: 0, subversion: 1, care: 2, hope: 2, energy: 2 },
  "COMMITMENT":           { anger: 0, comedy: 0, subversion: 0, care: 2, hope: 3, energy: 0 },
...
const SURFACES_VOICE_FOR: Partial<Record<VulnerableGroup, Set<string>>> = {
  woman:      new Set(["PETITION", "EMAIL", "WRITING", "MEETING", "SOCIAL MEDIA", "NEWS STORY"]),
  immigrant:  new Set(["PETITION", "EMAIL", "WRITING", "MEETING", "SOCIAL MEDIA", "NEWS STORY", "TRAINING"]),
  lgbtq:      new Set(["PETITION", "EMAIL", "WRITING", "MEETING", "SOCIAL MEDIA", "NEWS STORY", "MENTAL HEALTH"]),
  repro:      new Set(["PETITION", "EMAIL", "WRITING", "MEETING", "SOCIAL MEDIA", "NEWS STORY", "TRANSPORTATION"]),
  disabled:   new Set(["PETITION", "EMAIL", "WRITING", "MEETING", "SOCIAL MEDIA", "PROFESSIONAL SKILLS"]),
  fedWorker:  new Set(["NEWS STORY", "EMAIL", "PROFESSIONAL SKILLS", "TRAINING"]),
  journalist: new Set(["NEWS STORY", "AMPLIFY", "PROFESSIONAL SKILLS", "WRITING"]),
  black:      new Set(["PETITION", "EMAIL", "WRITING", "NEWS STORY", "SOCIAL MEDIA", "MEETING"]),
  latino:     new Set(["PETITION", "EMAIL", "WRITING", "NEWS STORY", "SOCIAL MEDIA", "MEETING"]),
  indigenous: new Set(["PETITION", "EMAIL", "WRITING", "NEWS STORY", "SOCIAL MEDIA", "MEETING"]),
  asian:      new Set(["PETITION", "EMAIL", "WRITING", "NEWS STORY", "SOCIAL MEDIA"]),
  muslim:     new Set(["PETITION", "EMAIL", "WRITING", "NEWS STORY", "SOCIAL MEDIA"]),
  jewish:     new Set(["PETITION", "EMAIL", "WRITING", "NEWS STORY", "SOCIAL MEDIA", "PRAYER"]),
  unionWorker: new Set(["LABOR", "PETITION", "EMAIL", "SOCIAL MEDIA"]),
  veteran:    new Set(["PETITION", "EMAIL", "NEWS STORY", "MEETING"]),
  student:    new Set(["PETITION", "EMAIL", "SOCIAL MEDIA", "MEETING"]),
  educator:   new Set(["PETITION", "EMAIL", "WRITING", "NEWS STORY"]),
  scientist:  new Set(["NEWS STORY", "PETITION", "PROFESSIONAL SKILLS", "WRITING"]),
