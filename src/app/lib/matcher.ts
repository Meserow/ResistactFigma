...
const SURFACES_VOICE_FOR: Partial<Record<VulnerableGroup, Set<string>>> = {
  ...
  repro:      new Set(["PETITION", "EMAIL", "WRITING", "MEETING", "SOCIAL MEDIA", "NEWS STORY", "TRANSPORT"]),
  disabled:   new Set(["PETITION", "EMAIL", "WRITING", "MEETING", "SOCIAL MEDIA", "SKILLS"]),
  fedWorker:  new Set(["NEWS STORY", "EMAIL", "SKILLS", "TRAINING"]),
  journalist: new Set(["NEWS STORY", "AMPLIFY", "SKILLS", "WRITING"]),
