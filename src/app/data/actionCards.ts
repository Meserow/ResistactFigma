...
export const STATIC_CARDS: ActionCardData[] = [
  ...
  { id: 8, category: "FLASH MOB", categoryColor: "#ff00d5", title: "Petition the Leftist Billionaires", description: "We need electronic billboards that show the daily price of eggs/gas since Trump took office. Another to show the Trump deficit versus Elon Musk's wealth. Another to show...", typeTag: "FLASH MOB", boosts: 5, spotsTotal: 10, authorName: "Nancie Kosnoff", authorRole: "Citizen Activist", topImage: imgImage14, authorAvatar: imgImage2 },
  { id: 9, category: "PETITION", categoryColor: "#05737f", title: "Stop Funding Fox", description: "MoveOn Civic Action has a long history of taking on Fox's lies. With actions taken by thousands of MoveOn members, we've been able to put pressure on cable providers to drop Fox News.", location: "Austin, TX", boosts: 5, spotsTotal: 10, authorName: "Meg Jones", authorRole: "Franklin High School", topImage: imgImage21, authorAvatar: imgImage4 },
  { id: 10, category: "PROTEST", categoryColor: "#23297e", title: "Towns Across America Blackout", description: "On Tuesday, April 22, 2025, we invite you to participate in a nationwide television blackout in protest of Trump's signing of the bill to defund Planned Parenthood.", location: "Austin, TX", boosts: 5, spotsTotal: 10, authorName: "Patrick Escarcega", authorRole: "Citizen Activist", topImage: imgImage17, authorAvatar: imgImage1 },
  { id: 11, category: "ART PIECE", categoryColor: "#896312", title: "Puppets for March on Washington", description: "We are making effigies of Trump and his minions for the March on Washington on July 4th. Join in even if you can't attend — we will help the attendees get them!", location: "Austin, TX", boosts: 5, spotsTotal: 10, authorName: "John Smith", authorRole: "MoveOn.org", topImage: imgImage8, authorAvatar: imgImage20 },
  ...
  { id: 17, category: "ART PIECE", categoryColor: "#896312", title: "Puppets for March on Washington", description: "We are making effigies of Trump and his minions for the March on Washington on July 4th. Join in even if you can't attend — we will help the attendees get them!", location: "Austin, TX", boosts: 500, spotsTotal: "Unlimited", authorName: "Adam Jordan", authorRole: "Catholic Legal Immigration Network", authorLink: "https://www.cliniclegal.org/", topImage: imgImage9, authorAvatar: imgImage3 },
  { id: 18, category: "FUNDING", categoryColor: "#127f05", title: "Help Fund my Elon Mural!", description: "I am making a mural to show Elon as a reincarnation of Adolf Hitler, using a real photo of Trump giving the Nazi salute! It will be in my community center's parking lot!", isOnline: true, boosts: 500, spotsTotal: "Unlimited", authorName: "Nancie Kosnoff", authorRole: "Citizen Activist", topImage: imgImage11, authorAvatar: imgImage2 },
];
