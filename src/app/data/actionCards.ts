...
export const STATIC_CARDS: ActionCardData[] = [
  { id: 5, isFeatured: true, category: "Amplify", categoryColor: "#8a00e6", title: "Spread the Word about ResistAct", description: "Resistance grows one share at a time — but only if you actually share. Pick a friend who's been doomscrolling and send this their way. If everyone here invites two friends, ResistAct doubles by Tuesday. That's how movements actually scale — not virally, but two-by-two, through people who trust each other.", boosts: 2, spotsTotal: "Unlimited", authorName: "Ellen Meserow", authorRole: "ResistAct Founder", topImage: "/og-image-v3.webp", authorAvatar: imgImage34 },
];
