...
export const STATIC_CARDS: ActionCardData[] = [
  ...
  { id: 8, category: "FLASH MOB", categoryColor: "#ff00d5", title: "Petition the Leftist Billionaires", description: "We need electronic billboards that show the daily price of eggs/gas since Trump took office. Another to show the Trump deficit versus Elon Musk's wealth. Another to show how many Americans have lost healthcare under this administration. Sign our petition to get Soros, Gates, Bezos, and other progressive billionaires to fund these in swing states!", typeTag: "FLASH MOB", boosts: 0, spotsTotal: 10, authorName: "Nancie Kosnoff", authorRole: "Citizen Activist", topImage: imgImage14, authorAvatar: imgImage2 },
  ...
  { id: 14, category: "FLASH MOB", categoryColor: "#ff00d5", title: "Petition the Leftist Billionaires", description: "We need electronic billboards that show the daily price of eggs/gas since Trump took office. Another to show the Trump deficit versus Elon Musk's wealth. Another to show how many Americans have lost healthcare under this administration. Sign our petition to get Soros, Gates, Bezos, and other progressive billionaires to fund these in swing states!", typeTag: "FLASH MOB", boosts: 500, spotsTotal: "Unlimited", authorName: "Nancie Kosnoff", authorRole: "Citizen Activist", topImage: imgImage15, authorAvatar: imgImage2 },
