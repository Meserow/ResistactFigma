...
// Three-phase hero reveal (no loop), shared by the logged-out and logged-in
// heroes so both play the identical centered intro before the logo settles.
...
export function HeroLogoReveal({ onResolved }: HeroLogoRevealProps) {
