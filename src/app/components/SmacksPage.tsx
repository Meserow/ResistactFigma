            ...
            <div className="flex-1 overflow-y-auto px-5 pb-5 space-y-4">
              ...
              <div className="grid grid-cols-4 gap-2">
                ...
                {typeof navigator !== "undefined" && "share" in navigator && (
                  <button
                    onClick={() => { markShared(shareReceipt.id); handleNativeShare(); }}
                ...
                <button
                  onClick={() => { markShared(shareReceipt.id); handleCopyImage(); }}
                ...
                {/* Facebook — spot 1 */}
                <button
                  onClick={() => { markShared(shareReceipt.id); handleFacebookShare(shareReceipt); }}
                ...
                <a
                  ...
                  onClick={() => markShared(shareReceipt.id)}
                ...
                {/* Instagram — spot 4 */}
                <button
                  onClick={() => { markShared(shareReceipt.id); handleInstagramShare(shareReceipt); }}
