...
function ReceiptTile({
  ...
  return (
    <>
    <div
      className={`rounded-2xl overflow-hidden border border-gray-600 shadow-md hover:shadow-lg transition-all bg-white flex flex-col ${!receipt.adminApproved && isAdmin ? "ring-2 ring-red-400" : ""}`}
    >
      {/* Pending banner */}
